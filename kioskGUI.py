...
def run_kiosk_gui(parent):
    ...
    main_frame.pack(anchor="nw", padx=30)

    # --- Second Frame ---
    second_frame = Frame(parent, bg="#1e1f1e")
    ...
    def togglePhoto():
        nonlocal currently_showing_live_capture, last_detected_frame, second_detected_frame
    ...
    def update_preview_frame():
        ...
        parent.after(10, update_preview_frame)

    def takePhoto():
        nonlocal second_detected_frame, live_preview_running, second_photo
        live_preview_running = False
    ...
    def submit():
        nonlocal label, color, description_entry, location_entry
    ...
    def return_to_main():
        nonlocal label, color, second_photo
        ...
        nonlocal pressed, continue_updating
        pressed = False
        continue_updating = True
    ...
    def show_second_screen():
        ...
        nonlocal last_detected_frame, description_entry, item_entry, location_entry, color_entry, result_label, capture_button, photo_button, toggle_button

        main_frame.pack_forget()
        second_frame.pack(anchor="nw", padx=30)
    ...
    # --- Frame Updater ---
    def update_frame():
        nonlocal pressed, label, color, last_detected_frame, continue_updating
        ...
        if pressed:
            ...
            parent.after(2000, show_second_screen)
            return
